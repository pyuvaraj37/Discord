...
class Voice(commands.Cog):
    ...
    async def play(self, ctx, url=None):
        ...
        if ctx.voice_client in self.client.voice_clients:
            ...
            ctx.send('Add me to a voice channel by first joining a channel, then type !join')
